...
var CommentForm = require('view/comment/CommentForm');
var CommentView = require('view/comment/CommentView');
var CollectionView = require('view/CollectionView');

var template = require('view/comment/templates/CommentsSection.html');

module.exports = Plumage.view.comment.CommentsSection = ModelView.extend({
  ...
  resetCommentForm: function() {
    if (this.commentForm) {
      this.commentForm.setModel(new CommentModel({
